...
const contentMap = {
  'Обо мне': `
    ...
    <p>Креатор / Копирайтер / Специалист по маркетинговым коммуникациям</p>
    <img src="images/my-photo.JPG" alt="На фото я, кстати" style="max-width:100%; margin:10px 0;">
    <p>Люблю придумывать рекламу.</p>
    <p>Вчерашний студент, сегодняшний дипломированный специалист с агентским опытом.</p>
    <p>Успел поработать с федеральными сетями фастфуда, одним известным брендом зубной пасты и другими крутыми компаниями.</p>
  `,
  'Портфолио': `
    <h2>Мои проекты</h2>
    <p>Креатив:</p>
