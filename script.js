...
const contentMap = {
  'Обо мне': `
    ...
    <p>Люблю делать эффективную и креативную рекламу.</p>
    <p>Работал креатором в агентстве "Штольцман и Кац", но сейчас хочу поменять свою специализацию и перейти в маркетинг.</p>
